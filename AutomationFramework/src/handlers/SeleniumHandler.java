	 ...
	 public static WebDriver SwitchDriver() throws Exception
	    {
	        ...
	        { 
	            ...
	            switch(currentBrowser)
	            {
	                case FF:
	                    {
	                        ...
	                        {
	                        	File f = new File(PropertiesAndConstants.CurrentDirectory + "Users\\sri.zampani\\workspace\\Automation_New\\Drivers\\JSErrorCollector.xpi");
	                            if (f.exists())
	                            {
	                ...
	                case IE:
	                    {
	                    	...
	                    	File file = new File(PropertiesAndConstants.CurrentDirectory + "Users\\sri.zampani\\workspace\\Automation_New\\Drivers\\IEDriverServer.exe");
	                ...
	                case CH:
	                    {
	                    	File file = new File(PropertiesAndConstants.CurrentDirectory + "Users\\sri.zampani\\workspace\\Automation_New\\Drivers\\chromedriver.exe");
